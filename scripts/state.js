...
/* ترتیب تعیین‌شده: ۱) سبزِ اصلی  ۲) نارنجیِ برند  ۳) زرد
   ۴ به بعد: رنگ‌هایی که نه با سه‌تای بالا اشتباه می‌شوند نه با ذغالیِ
   سطحِ پروژه و نه با کهرباییِ «در انتظار بازبینی». */
var PART_COLORS=["#16a34a","#f7941f","#eab308","#2563eb","#7c3aed","#db2777","#0891b2","#a16207"];
