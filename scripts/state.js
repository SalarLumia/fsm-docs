...
/* ترتیب تعیین‌شده: ۱) نارنجیِ برند  ۲) طلاییِ روشن
   ۳ به بعد: رنگ‌هایی خارج از خانوادهٔ گرم، تا با دوتای بالا و با
   زردِ سطحِ پروژه و کهرباییِ «در انتظار بازبینی» قاطی نشوند. */
var PART_COLORS=["#f7941f","#fbcf88","#16a34a","#2563eb","#7c3aed","#db2777","#0891b2","#0d9488"];
